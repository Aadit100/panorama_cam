...
void calc_wheel_yaw(){
  ...
  if(wheel_yaw>180){
    wheel_yaw-=360*int((int(wheel_yaw/180)+1)/2);   //keep yaw between -180 and 180
  }
  else if(wheel_yaw<-180){
    wheel_yaw+=360*int((1+int(abs(wheel_yaw)/180))/2);
  }
}
